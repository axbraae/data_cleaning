...
An overwhelmingly large number of surveyed individuals were not even going trick or treating! And the average age was overwhelmingly adult between 25 and 50 years old.
...
rated_clean_candy %>%
  ...
  ggplot() +
  aes(x = total_ratings, y = reorder(candy, -total_ratings), ) +
  geom_col() +
  scale_fill_discrete_qualitative(
    palette = "set 3", nmax = 5, order = c(5, 1, 2)) +
  theme +
